...
list.files(path = "./Processed_Data/20240726_DH", pattern = "results*", full.names = T)

results <- list.files(path = "./Processed_Data/20240726_DH", pattern = "results*", full.names = T) |> 
...
#### Bring in Abs values ----
run_date <- "20240726"
abs <- read.csv("./Processed_Data/20240726_DH/CDOMall_20240726.csv")
...
write.csv(export, "./Processed_Data/20240726_DH/Results_EEMs_Abs_20240726.csv", row.names = F)
