...
##read in EDI data 
ctd_edi <- read_csv("https://pasta.lternet.edu/package/data/eml/edi/200/15/9d741c9cced69cfd609c473ada2812b1" ) |> filter(Reservoir == "CCR")
...
ctd_bind <- ccr_ctd_24 |> 
  ...
  filter(!Date %in% c(ymd("2024-07-31"), ymd("2024-08-01"), ymd("2024-08-15")),
         Date > ymd("2024-05-20"),
         Date < ymd("2025-04-17"))   #non EEM sample days
...
sensors <- rbind(ctd_bind, ysi_bind) |> 
  filter(Date > ymd("2024-05-20"),
         Date < ymd("2025-04-17")) |>  # remove S1 measurement from before sampling
  arrange(Date, Site, Depth_m)

write.csv(sensors, "./Sensor_Data_compiled.csv", row.names = F)
...
sensors |> 
  ...
  filter(#name == "Temp_C",
         Site %in% c(50, 88, 90),
         Date %in% c(ymd("2024-09-16"), ymd("2024-09-30"))) |> 
  ggplot(aes(x = Temp_C, y = Depth_m, linetype = as.factor(Date)))+
...
sensors |> 
  ...
  filter(#name == "Temp_C",
         Site %in% c(50, 88, 90),
         Date %in% c(ymd("2024-09-16"), ymd("2024-09-30"))) |> 
  ggplot(aes(x = SpCond_uScm, y = Depth_m, linetype = as.factor(Date)))+
  geom_line(orientation = "y")+
  scale_y_reverse()+
  facet_wrap(~Site, scales = "free_y", nrow = 1)+
  theme_bw()
...
## C2 HOBO buoys THROUGH April 2025

C2 April - October 

```{r}
hobo_C2_b6 <- read.csv("https://raw.githubusercontent.com/CareyLabVT/ManualDownloadsSCCData/master/CCR_manual_downloads/CCR_Hobos/Cove_Pool_buoys/C2_2024/hobo10_C2_16apr25.csv", skip = 1) |> 
  select(2:3) |> rename(DateTime = 1, Temp_C = 2) |> mutate(Site = "C2", Depth = 0.75)

hobo_C2_b7 <- read.csv("https://raw.githubusercontent.com/CareyLabVT/ManualDownloadsSCCData/master/CCR_manual_downloads/CCR_Hobos/Cove_Pool_buoys/C2_2024/hobo13_C2_16apr25.csv", skip = 1) |> 
  select(2:3) |> rename(DateTime = 1, Temp_C = 2) |> mutate(Site = "C2", Depth = 0.5)

hobo_C2_b2 <- read.csv("https://raw.githubusercontent.com/CareyLabVT/ManualDownloadsSCCData/master/CCR_manual_downloads/CCR_Hobos/Cove_Pool_buoys/C2_2024/hobo168_C2_16apr25.csv", skip = 1) |> 
  select(2:3) |> rename(DateTime = 1, Temp_C = 2) |> mutate(Site = "C2", Depth = 1.75)

hobo_C2_b3 <- read.csv("https://raw.githubusercontent.com/CareyLabVT/ManualDownloadsSCCData/master/CCR_manual_downloads/CCR_Hobos/Cove_Pool_buoys/C2_2024/hobo19_C2_16apr25.csv", skip = 1) |> 
  select(2:3) |> rename(DateTime = 1, Temp_C = 2) |> mutate(Site = "C2", Depth = 1.5)

hobo_C2_b8 <- read.csv("https://raw.githubusercontent.com/CareyLabVT/ManualDownloadsSCCData/master/CCR_manual_downloads/CCR_Hobos/Cove_Pool_buoys/C2_2024/hobo30_C2_16apr25.csv", skip = 1) |> 
  select(2:3) |> rename(DateTime = 1, Temp_C = 2) |> mutate(Site = "C2", Depth = 0.25)

hobo_C2_b5 <- read.csv("https://raw.githubusercontent.com/CareyLabVT/ManualDownloadsSCCData/master/CCR_manual_downloads/CCR_Hobos/Cove_Pool_buoys/C2_2024/hobo31_C2_16apr25.csv", skip = 1) |> 
  select(2:3) |> rename(DateTime = 1, Temp_C = 2) |> mutate(Site = "C2", Depth = 1)

hobo_C2_b1 <- read.csv("https://raw.githubusercontent.com/CareyLabVT/ManualDownloadsSCCData/master/CCR_manual_downloads/CCR_Hobos/Cove_Pool_buoys/C2_2024/hobo39_C2_16apr25.csv", skip = 1) |> 
  select(2:3) |> rename(DateTime = 1, Temp_C = 2) |> mutate(Site = "C2", Depth = 2)

hobo_C2_b9 <- read.csv("https://raw.githubusercontent.com/CareyLabVT/ManualDownloadsSCCData/master/CCR_manual_downloads/CCR_Hobos/Cove_Pool_buoys/C2_2024/hobo63_C2_16apr25.csv", skip = 1) |> 
  select(2:3) |> rename(DateTime = 1, Temp_C = 2) |> mutate(Site = "C2", Depth = 0.1)

hobo_C2_b4 <- read.csv("https://raw.githubusercontent.com/CareyLabVT/ManualDownloadsSCCData/master/CCR_manual_downloads/CCR_Hobos/Cove_Pool_buoys/C2_2024/hobo68_C2_16apr25.csv", skip = 1) |> 
