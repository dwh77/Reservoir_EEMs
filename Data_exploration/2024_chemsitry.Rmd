...
distances <- read.csv("C:/Users/dwh18/Downloads/2024 spatial sampling - Distances (1).csv") |> 
...
site_class <- read.csv("C:/Users/dwh18/Downloads/2024 spatial sampling - Sites_Class (1).csv") |> 
  dplyr::select(-X, -Key) |> 
  mutate(Date = mdy(Date)) |> 
...
# ggsave("./igc25_figures/DOC.png", igc_doc, height = 8, width = 10, units = "in")
# ggsave("./igc25_figures/HIX.png", igc_hix, height = 8, width = 19, units = "in")
ggsave("./igc25_figures/DOC_HIX_combo.png", igc_doc_hix, height = 8, width = 19, units = "in")


#HIX and DOC no color 
igc_hix_nocolor <- data2 |>   ggplot(aes(x = Distance, y = HIX_mean, fill = Depth_m))+
  geom_point(shape = 1, size = 4) + #shape = 21,
  geom_smooth()+
  theme_bw()+ theme(legend.position = "top", text = element_text(size = 36),
                    legend.text = element_text(size=18),
                    panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
    labs(x= "Distance from Stream (m)", y = "Humification Index (HIX)", fill = "Depth (m)",  shape = "Site Type")+
  scale_x_continuous(breaks = c(0, 500, 1000, 1500))

igc_doc_nocolor <- data2 |>   ggplot(aes(x = Distance, y = DOC_mean, fill = Depth_m))+
  geom_point(shape = 1, size = 4) + #shape = 21,
  geom_smooth()+
  theme_bw()+ theme(legend.position = "top", text = element_text(size = 36),
                    legend.text = element_text(size=18),
                    panel.grid.major = element_blank(), panel.grid.minor = element_blank())+
    labs(x= "Distance from Stream (m)", y = "DOC (mg/L)", fill = "Depth (m)",  shape = "Site Type")+
  scale_x_continuous(breaks = c(0, 500, 1000, 1500))

igc_doc_hix_nocolor <- ggpubr::ggarrange(igc_doc_nocolor, igc_hix_nocolor, nrow = 1, labels = "auto", font.label = list(size = 28))

ggsave("./igc25_figures/DOC_HIX_combo_nocolor.png", igc_doc_hix_nocolor, height = 8, width = 19, units = "in")
...
igc_dates <- data2 |> 
  ...
  theme_bw()+ theme(legend.position = "top", text = element_text(size = 32),
...
ggsave("./igc25_figures/acrossdates_FIN.png", igc_dates, height = 10, width = 20, units = "in")


doc_hix_dates <- data2 |> 
# filter(Date %in% c(ymd("2024-05-22"), ymd("2024-12-17"), 
  #ymd("2024-09-16"), ymd("2024-09-30"), ymd("2024-10-28"))) |> 
...
doc_hix_dates
#ggsave("./igc25_figures/DOC_HIX_SUBdates_FIN.png", doc_hix_dates, height = 6, width = 14, units = "in")
