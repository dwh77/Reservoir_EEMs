...
eems <- eems24 |> 
  ...
  select(Reservoir, Site, Site_code, Depth_m, Date, FI., HIX., BIX., T., A., A.T., a254, a350, A254, A350 )
...
eems_plotting <- left_join(eems, distances, by = c("Site_code", "Date")) |> 
  ...
  select(Reservoir, Site, Site_code, Depth_m, Date, Distance, Dry_start, Dry_end, FI., HIX., BIX., T., A., A.T., a254, a350)
...
eems_summary <- eems_plotting |> 
  ...
  select(Site, Depth_m, Date, Distance, HIX) |> 
  group_by(Site, Depth_m, Date, Distance) |> 
